  ...
  return (
    <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
      <div style={{ position: "absolute", left: 14, pointerEvents: "none" }}>
        <Icon size={16} color="oklch(0.42 0.03 250)" />
      </div>
      <input
        type={type} value={value} placeholder={placeholder}
        onChange={e => onChange(e.target.value)}
        style={{ width: "100%", padding: "13px 44px 13px 42px", borderRadius: 12, background: "oklch(0.13 0.025 250)", border: "1px solid oklch(0.22 0.03 250)", color: "oklch(0.90 0.01 250)", fontFamily: "Inter, sans-serif", fontSize: 14, outline: "none", boxSizing: "border-box", transition: "border-color 0.2s" }}
        onFocus={e => (e.target.style.borderColor = TEAL)}
        onBlur={e => (e.target.style.borderColor = "oklch(0.22 0.03 250)")}
      />
...
function GoogleBtn({ onClick, label }: { onClick: () => void; label: string }) {
  return (
    <button onClick={onClick} style={{ width: "100%", padding: "13px 0", borderRadius: 12, border: "1px solid oklch(0.24 0.03 250)", background: "oklch(0.14 0.025 250)", color: "oklch(0.85 0.01 250)", fontFamily: "Outfit, sans-serif", fontWeight: 600, fontSize: 14, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
...
function AuthDivider() {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "2px 0" }}>
      ...
      <span style={{ fontSize: 11, color: "oklch(0.38 0.03 250)", fontFamily: "JetBrains Mono, monospace" }}>hoặc</span>
      <div style={{ flex: 1, height: 1, background: "oklch(0.22 0.03 250)" }} />
    </div>
  );
}
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflowY: "auto", scrollbarWidth: "none" }}>
      ...
      <div style={{ padding: "48px 28px 28px", textAlign: "center", background: `radial-gradient(ellipse 80% 120px at 50% 0%, ${TEAL}18, transparent)` }}>
        ...
        <p style={{ fontSize: 10, color: "oklch(0.40 0.03 250)", fontFamily: "JetBrains Mono, monospace", margin: 0, letterSpacing: 1.5 }}>KOREAN IT · AI</p>
      </div>

      <div style={{ padding: "8px 28px 32px", display: "flex", flexDirection: "column", gap: 12 }}>
        <div>
          <p style={{ fontFamily: "Outfit, sans-serif", fontWeight: 700, fontSize: 20, color: "oklch(0.92 0.01 250)", margin: "0 0 2px" }}>Chào mừng trở lại 👋</p>
          <p style={{ fontSize: 12, color: "oklch(0.48 0.03 250)", margin: "0 0 20px", fontFamily: "Inter, sans-serif" }}>Đăng nhập để tiếp tục học tập</p>
        </div>
        ...
        <AuthInput
          ...
          right={
            <button onClick={() => setShowPwd(v => !v)} style={{ background: "none", border: "none", cursor: "pointer", padding: 0, display: "flex" }}>
              {showPwd ? <EyeOff size={16} color="oklch(0.42 0.03 250)" /> : <Eye size={16} color="oklch(0.42 0.03 250)" />}
            </button>
          }
        />
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "oklch(0.50 0.03 250)", fontFamily: "Inter, sans-serif", margin: "8px 0 0" }}>
          Chưa có tài khoản?{" "}
...
function RegisterScreen({ nav }: { nav: (s: Screen) => void }) {
  ...
  const strengthMeta = [
    { label: "", color: "oklch(0.22 0.03 250)" },
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflowY: "auto", scrollbarWidth: "none" }}>
      ...
      <div style={{ padding: "16px 20px 0", display: "flex", alignItems: "center", gap: 10 }}>
        <button onClick={() => nav("login")} style={{ width: 36, height: 36, borderRadius: 10, background: "oklch(0.14 0.025 250)", border: "1px solid oklch(0.22 0.03 250)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
          <ChevronLeft size={18} color="oklch(0.70 0.01 250)" />
        </button>
        <p style={{ fontFamily: "Outfit, sans-serif", fontWeight: 700, fontSize: 17, color: "oklch(0.92 0.01 250)", margin: 0 }}>Tạo tài khoản</p>
      </div>

      <div style={{ padding: "20px 28px 32px", display: "flex", flexDirection: "column", gap: 12 }}>
        <div style={{ marginBottom: 4 }}>
          <p style={{ fontFamily: "Outfit, sans-serif", fontWeight: 700, fontSize: 18, color: "oklch(0.90 0.01 250)", margin: "0 0 2px" }}>Bắt đầu hành trình 🚀</p>
          <p style={{ fontSize: 12, color: "oklch(0.48 0.03 250)", margin: 0, fontFamily: "Inter, sans-serif" }}>Học IT tiếng Hàn cùng AI — miễn phí</p>
        </div>
          ...
          {password.length > 0 && (
            <div>
              <div style={{ display: "flex", gap: 4 }}>
                {[1, 2, 3, 4].map(i => (
                  <div key={i} style={{ flex: 1, height: 3, borderRadius: 2, background: i <= strength ? strengthMeta[strength].color : "oklch(0.22 0.03 250)", transition: "background 0.3s" }} />
                ))}
              </div>
        ...
        <AuthInput
          ...
          right={
            <button onClick={() => setShowConfirm(v => !v)} style={{ background: "none", border: "none", cursor: "pointer", padding: 0, display: "flex" }}>
              {showConfirm ? <EyeOff size={16} color="oklch(0.42 0.03 250)" /> : <Eye size={16} color="oklch(0.42 0.03 250)" />}
            </button>
          }
        />
        ...
        <button onClick={() => setAgreed(v => !v)} style={{ display: "flex", alignItems: "flex-start", gap: 10, background: "none", border: "none", cursor: "pointer", padding: "4px 0", textAlign: "left" }}>
          <div style={{ width: 18, height: 18, borderRadius: 5, border: `2px solid ${agreed ? TEAL : "oklch(0.30 0.03 250)"}`, background: agreed ? `${TEAL}20` : "none", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 1 }}>
            {agreed && <Check size={11} color={TEAL} />}
          </div>
          <span style={{ fontSize: 12, color: "oklch(0.55 0.03 250)", fontFamily: "Inter, sans-serif", lineHeight: 1.5 }}>
            Tôi đồng ý với{" "}
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "oklch(0.50 0.03 250)", fontFamily: "Inter, sans-serif", margin: "6px 0 0" }}>
          Đã có tài khoản?{" "}
...
function ForgotPasswordScreen({ nav }: { nav: (s: Screen) => void }) {
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflowY: "auto", scrollbarWidth: "none" }}>
      {/* Header */}
      <div style={{ padding: "16px 20px 0", display: "flex", alignItems: "center", gap: 10 }}>
        <button onClick={() => step > 0 ? setStep(s => (s - 1) as 0 | 1 | 2) : nav("login")} style={{ width: 36, height: 36, borderRadius: 10, background: "oklch(0.14 0.025 250)", border: "1px solid oklch(0.22 0.03 250)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
          <ChevronLeft size={18} color="oklch(0.70 0.01 250)" />
        </button>
        <p style={{ fontFamily: "Outfit, sans-serif", fontWeight: 700, fontSize: 17, color: "oklch(0.92 0.01 250)", margin: 0 }}>Quên mật khẩu</p>
      </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 0 }}>
          {stepMeta.map((s, i) => (
            <React.Fragment key={i}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
                <div style={{ width: 32, height: 32, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", background: i < step ? `${TEAL}20` : i === step ? `${TEAL}30` : "oklch(0.14 0.025 250)", border: `2px solid ${i <= step ? TEAL : "oklch(0.22 0.03 250)"}`, transition: "all 0.3s" }}>
                  {i < step
                    ? <Check size={14} color={TEAL} />
                    : <s.icon size={13} color={i === step ? TEAL : "oklch(0.38 0.03 250)"} />
                  }
                </div>
                <span style={{ fontSize: 9, fontFamily: "JetBrains Mono, monospace", color: i === step ? TEAL : "oklch(0.35 0.03 250)", letterSpacing: 0.3, whiteSpace: "nowrap" }}>{s.label.toUpperCase()}</span>
              </div>
              {i < 2 && (
                <div style={{ flex: 1, height: 2, background: i < step ? TEAL : "oklch(0.22 0.03 250)", margin: "0 4px", marginBottom: 18, transition: "background 0.3s" }} />
              )}
            </React.Fragment>
          ))}
        </div>
        ...
        {step === 0 && (
          <>
            <div style={{ textAlign: "center", marginBottom: 8 }}>
              ...
              <p style={{ fontFamily: "Outfit, sans-serif", fontWeight: 700, fontSize: 17, color: "oklch(0.90 0.01 250)", margin: "0 0 6px" }}>Xác nhận địa chỉ email</p>
              <p style={{ fontSize: 12, color: "oklch(0.50 0.03 250)", fontFamily: "Inter, sans-serif", margin: 0, lineHeight: 1.6 }}>Chúng tôi sẽ gửi mã xác nhận{"\n"}đến email của bạn</p>
            </div>
        ...
        {step === 1 && (
          <>
            <div style={{ textAlign: "center", marginBottom: 8 }}>
              ...
              <p style={{ fontFamily: "Outfit, sans-serif", fontWeight: 700, fontSize: 17, color: "oklch(0.90 0.01 250)", margin: "0 0 6px" }}>Nhập mã xác nhận</p>
              <p style={{ fontSize: 12, color: "oklch(0.50 0.03 250)", fontFamily: "Inter, sans-serif", margin: 0, lineHeight: 1.6 }}>
            ...
            <div style={{ display: "flex", gap: 8, justifyContent: "center", position: "relative" }}>
              {[0, 1, 2, 3, 4, 5].map(i => (
                <div key={i} style={{ width: 44, height: 52, borderRadius: 10, border: `2px solid ${otp[i] ? TEAL : "oklch(0.22 0.03 250)"}`, background: "oklch(0.13 0.025 250)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Outfit, sans-serif", fontWeight: 800, fontSize: 22, color: TEAL, transition: "border-color 0.2s" }}>
            ...
            <p style={{ textAlign: "center", fontSize: 12, color: "oklch(0.48 0.03 250)", fontFamily: "Inter, sans-serif" }}>
              {countdown > 0
        ...
        {step === 2 && (
          <>
            <div style={{ textAlign: "center", marginBottom: 8 }}>
              ...
              <p style={{ fontFamily: "Outfit, sans-serif", fontWeight: 700, fontSize: 17, color: "oklch(0.90 0.01 250)", margin: "0 0 6px" }}>Đặt mật khẩu mới</p>
              <p style={{ fontSize: 12, color: "oklch(0.50 0.03 250)", fontFamily: "Inter, sans-serif", margin: 0 }}>Chọn mật khẩu mạnh để bảo vệ tài khoản</p>
            </div>
    ...
    <div style={{ flex: 1, overflowY: "auto", scrollbarWidth: "none" }}>
      ...
      {showLogoutConfirm && (
        <div style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,0.65)", display: "flex", alignItems: "flex-end", zIndex: 100 }}>
          <div style={{ width: "100%", padding: "24px 20px 32px", background: "oklch(0.13 0.025 250)", borderTop: "1px solid oklch(0.22 0.03 250)", borderRadius: "20px 20px 0 0" }}>
            <div style={{ width: 40, height: 4, borderRadius: 2, background: "oklch(0.28 0.03 250)", margin: "0 auto 20px" }} />
            <div style={{ textAlign: "center", marginBottom: 20 }}>
              ...
              <p style={{ fontFamily: "Outfit, sans-serif", fontWeight: 700, fontSize: 17, color: "oklch(0.92 0.01 250)", margin: "0 0 6px" }}>
                {lang === "vi" ? "Xác nhận đăng xuất" : "Confirm logout"}
              </p>
              <p style={{ fontSize: 13, color: "oklch(0.50 0.03 250)", fontFamily: "Inter, sans-serif", margin: 0 }}>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <button
                ...
                style={{ flex: 1, padding: "13px 0", borderRadius: 12, border: "1px solid oklch(0.24 0.03 250)", background: "oklch(0.16 0.025 250)", color: "oklch(0.75 0.01 250)", fontFamily: "Outfit, sans-serif", fontWeight: 600, fontSize: 14, cursor: "pointer" }}
              >
                {lang === "vi" ? "Huỷ" : "Cancel"}
              </button>
              <button
